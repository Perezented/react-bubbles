...
-   [ ] What steps can you take in your web apps to keep your data secure?
        Encryption and dont post them

---

-   [ ] Describe how web servers work.
        Its a mainframe of sorts. Has computers connected together. The website is stored on the said server. When we type in the site address, we connect to whatever server has it through the web of the internet. The site is on the servers, not in the air.
